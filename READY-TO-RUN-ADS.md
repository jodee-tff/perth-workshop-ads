# Ready-to-Run Ads: Perth AI Mastery Workshop

> Copy and paste directly into Meta Ads Manager.
> Event: AI Mastery Workshop | Date: Monday 28 April 2026 | Location: Perth, WA

---

## How to Use This File

These 5 ads are prioritised by campaign phase and funnel position. Launch them in this order:

| Ad | Format | Campaign | Funnel | Launch |
|---|---|---|---|---|
| Ad 1 | Video (30 sec) | Campaign 2, Video Views | Top of funnel | Day 1 (27 Mar) |
| Ad 2 | Video (25 sec) | Campaign 2, Video Views | Top of funnel | Day 1 (27 Mar) |
| Ad 3 | Static image | Campaign 1, Registrations | Mid funnel (cold) | Day 4 (30 Mar) |
| Ad 4 | Static image | Campaign 1, Registrations | Mid funnel (cold) | Day 4 (30 Mar) |
| Ad 5 | Static image | Campaign 1, Registrations | Bottom funnel (retarget) | Day 8 (3 Apr) |
...
**Format:** Vertical video (9:16), 30 seconds, speaker-to-camera, UGC style
...
## Ad 2: "The Demo" (Video, Awareness)

**Purpose:** Top-of-funnel video showing AI in action. Builds curiosity and retargeting pools. Runs alongside Ad 1 in Campaign 2 from Day 1.

**Format:** Vertical video (9:16), 25 seconds, screen recording + speaker-to-camera, UGC style
...
**[SECONDS 3–12] THE REVEAL**
*Quick cuts between 2–3 screen recordings showing different AI tasks at speed:*
1. AI writing a week of social media content (3 sec)
2. AI analysing a spreadsheet and pulling out insights (3 sec)
3. AI drafting a client email in the speaker's tone (3 sec)

**Text overlays (one per cut):**
- "A week of content in 4 minutes"
- "Data analysis in 30 seconds"
...
**Format:** Static image (1080x1080 or 1080x1350). Speaker photo on one side, bold text on the other.
...
That's what the AI Mastery Workshop is all about.
...
→ Prompt frameworks that get expert-level outputs every time
...
## Ad 4: "The Story" (Static Image, Registration)

**Purpose:** Cold-audience conversion ad using narrative angle. Tests a different emotional entry point against Ad 3. Runs in Campaign 1, Ad Set 1A from Day 4.

**Format:** Static image (1080x1080 or 1080x1350). Text-heavy design on bold background colour OR speaker photo with minimal text overlay.
...
Here's what I hear from most people before they sign up: "I'm not sure I'm technical enough." Honestly? That's exactly who this is for. The workshop is designed for business people, not tech people. If you can send an email, you'll be absolutely fine.
...
## Quick Reference: Ad Specs for Meta Ads Manager

| Field | Ad 1 | Ad 2 | Ad 3 | Ad 4 | Ad 5 |
|---|---|---|---|---|---|
| **Format** | Video | Video | Image | Image | Image |
| **Aspect ratio** | 9:16 | 9:16 | 1:1 or 4:5 | 1:1 or 4:5 | 1:1 |
| **Duration** | 30 sec | 25 sec | N/A | N/A | N/A |
| **Campaign** | Video Views | Video Views | Conversions | Conversions | Conversions |
| **Audience** | Broad cold | Broad cold | Interest cold | Interest cold | Retargeting |
| **CTA Button** | Sign Up | Sign Up | Sign Up | Sign Up | Sign Up |
| **Launch day** | Day 1 | Day 1 | Day 4 | Day 4 | Day 8 |

---

## Placement Notes

- All ads should run across **Advantage+ Placements** (let Meta optimise).
- Videos are shot 9:16 for Reels/Stories. Meta will auto-adapt for Feed.
- Static images: provide both 1:1 (Feed) and 9:16 (Stories/Reels) versions where possible.
- All video must have **burnt-in captions**. 85% of video on Meta is watched without sound.
- Ensure the **landing page URL** is consistent across all ads and includes UTM parameters:
  `?utm_source=meta&utm_medium=paid&utm_campaign=perth-ai-workshop&utm_content=[ad-name]`

---

## Creative Rotation Plan

| Week | Active Ads | Notes |
|---|---|---|
| Week 1 (Days 1–7) | Ads 1, 2 | Video views campaign. Building retargeting pools. |
| Week 2 (Days 8–14) | Ads 1, 2, 3, 4, 5 | All ads live. Registration push begins. Ad 5 retargets video viewers + site visitors. |
| Week 3 (Days 15–21) | Top 2–3 performers | Kill underperformers. Scale winners by 20–30%. Swap Ad 5 copy to urgency: "Only X seats left." |
| Week 4 (Days 22–28) | Top 1–2 performers + fresh urgency creative | Consolidate budget. All copy shifts to final-call messaging. |

---

## Copy Swaps for Weeks 3–4 (Urgency Phase)

When you enter the urgency phase, swap the **Primary Text endings** and **Headlines** on your winning ads:
